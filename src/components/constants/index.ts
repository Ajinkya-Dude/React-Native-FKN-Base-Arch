export const FKNconstants = {
    ...
    dataFundacaoValid:'Informar uma data de fundação válida',
    dataFundacaoPlaceholder:'dd/mm/yyyy',
    cnae:'CNAE',
    classificacao:'Classificação',
    portador:'Portador',
    portadorPlaceholder:'Selecione uma Portador',
    prazo:'Prazo',
    prazoPlaceholder:'Selecione uma Prazo',
    transportadora:'Transportadora',
    transportadoraplaceholder:'Selecione uma Transportadora',
    regiao:'Região',
    regiaoPlaceholder:'Selecione uma Região',
    ramo:'Ramo',
    ramoPlaceholder:'Selecione um Ramo',
    segmento:'Segmento',
    segmentoPlaceholder:'Selecione um Segmento',
    information:'Informações',
    tabelaPadrao:'Tabela Padrão',
